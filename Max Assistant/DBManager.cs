    ...
    class DBManager
    {
        ...
        public DBManager()
        {
            try
            {
                ...
                cnx = new SqlConnection(@"Server=sqlserver;Database=GENSHOES;User Id=edgomez; Password=GeneralShoes20171; MultipleActiveResultSets=True");
        ...
        public void test_printreport(string query, string tablename, string xml, string reportrpt)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    ds.WriteXml(@"C:\Max Assistant\xml\" + xml + "");
